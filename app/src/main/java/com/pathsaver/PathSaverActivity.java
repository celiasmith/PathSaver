...
/* 
   This file implements the menu.  The main file is "PathSaverView.java", which implements finger tracking
   
   C Eliasmith 2014 based on R Kakarala, started 21 July 2011
   */
...
public class PathSaverActivity extends Activity {

    /** Menu ID for the command to save the positions. */
    private static final int SAVE_ID = Menu.FIRST;
    /** Menu ID for the command to clear the window. */
    private static final int CLEAR_ID = Menu.FIRST+1;
    /** Menu ID for the command to toggle fading. */
    private static final int SAMPLES_ID = Menu.FIRST+2;
    /** Menu ID for about **/
